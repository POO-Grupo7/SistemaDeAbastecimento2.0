 ...
 * @author lenovo
 */
public class RelatoriosGestorView extends javax.swing.JFrame {

    /**
     * Creates new form Relatorios
     */
    public RelatoriosGestorView() {
        initComponents();
        showPieChart();
        showLineChart();
        showBarChart();
...
//        painelHistograma.validate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatoriosGestorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
