 ...
 * @author lenovo
 */
public class RelatoriosOperadorView extends javax.swing.JFrame {

    /**
     * Creates new form Relatorios
     */
    public RelatoriosOperadorView() {
        initComponents();
        showPieChart();
        showLineChart();
        showBarChart();
...
//        painelHistograma.validate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatoriosOperadorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatoriosOperadorView().setVisible(true);
            }
        });
    }
